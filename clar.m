...
hal_note_Eb = harmonics(Eb,half,9,A_vect,1);

eight_note_F = harmonics(F,eight,9,A_vect,1);

half_note_D = harmonics(D,half,9,A_vect,1);

clar_melody = [eight_note_rest eight_note_G eight_note_G eight_note_G hal_note_Eb eight_note_rest eight_note_F eight_note_F eight_note_F half_note_D];
